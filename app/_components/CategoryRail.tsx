...
export default function CategoryRail({ selectedCategory, setSelectedCategory }: CategoryRailProps) {
    ...
    <div className="category-rail h-full flex flex-col justify-between">
      <div>
        {categoryList.map((category) => (
          <CategoryTile key={category} category={category} selectedCategory={selectedCategory} onClick={() => setSelectedCategory(category)} />
        ))}
      </div>
